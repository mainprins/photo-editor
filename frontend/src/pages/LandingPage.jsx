...
const LandingPage = () => {
  return (
    <div className='bg-teal-950 flex flex-col min-h-100 md:flex-row w-[100vw] h-[100vh] text-white'>
        
        <div id="right" className='flex justify-center items-center md:w-1/2 pt-12 xl:pt-0 h-[60vh] md:h-full'>
           <figure className=" bg-linear-to-br from-teal-500 to-amber-500 w-[60vw] h-[40vh] md:min-h-80 xl:min-h-100 xl:h-[60vh] xl:w-[30vw] sm:h-[40vh] sm:w-[40vw] rounded-t-full relative">
             <img src="/personPhotifier.png" alt="PersonLiking" className="object-contain w-full h-full scale-x-[-1]" />
             <div className="hidden xl:flex backdrop-blur-3xl rounded-md absolute top-15 -left-16 w-[15vw] p-4 gap-4 flex-col text-white">
                <h4>Adjustments</h4>
